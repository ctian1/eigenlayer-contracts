...
import "./StrategyManagerStorageBad.sol";
 ...
 */
contract StrategyManagerBad is
    Initializable,
    OwnableUpgradeable,
    ReentrancyGuardUpgradeable,
    Pausable,
    StrategyManagerStorageBad
{
    ...
    constructor(
        ...
        ISlasher _slasher
    ) StrategyManagerStorageBad(_delegation, _eigenPodManager, _slasher) {
